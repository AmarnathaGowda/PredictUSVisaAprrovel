...
from PredictUSVissaApproval.constants import APP_HOST, APP_PORT

from PredictUSVissaApproval.pipeline.prediction_pipeline import USvisaData, USvisaClassifier
